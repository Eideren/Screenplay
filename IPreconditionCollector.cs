namespace Screenplay
{
    public interface IPreconditionCollector
    {
        ...
        /// </summary>
        /// <remarks>
        /// When inside a <see cref="Precondition.Setup"/>, calling this method and passing true for
        /// <paramref name="state"/> will let the event waiting on that <see cref="Precondition"/> run
        /// </remarks>
